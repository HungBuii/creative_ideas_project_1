                        ...
                        <form action="{{ route('manager_edit_profile_submit', $single_manager->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Role</label>
                                        <input type="role" class="form-control" value="Marketing Manager" readonly style="cursor: not-allowed! important;">
                                    </div>
                                    <label>Photo</label>
                                ...
                                <button class="btn btn-secondary" style="margin-left: 10px; background-color: greenyellow">
                                    <a href="{{ route('manager_profile') }}" style="color: green">Back to Profile</a>
                                </button>
                            </div>
                        </form>
                    </div>
