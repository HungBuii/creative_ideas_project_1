...
<section class="pcoded-main-container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('student_faculties') }}">
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header" id="headingOne">
                                                <h5 class="mb-0"><a href="#!" data-toggle="collapse"
                                                        ...
                                                        aria-controls="collapseOne">Feedback</a></h5>
                                            </div>
                                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                                data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <img alt="No image"
                                                        src="{{ asset('/storage/uploads/' . $current_contribution->faculty->coordinator->photo) }}"
                                                        class="img-radius" style="max-width: 50px; max-height: 50px">
                                                    <span>
                                                        @isset($current_contribution->faculty->coordinator)
                                                        {{ $current_contribution->faculty->coordinator->name }}
                                                        @else
                                                        No comment
                                                        @endisset
                                                    </span>
                                                    <p></p>
                                                    @isset($current_contribution->comment)
                                                    {{ $current_contribution->comment->content }}
                                                    @else
                                                    No comment
                                                    @endisset
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Enter Title" name="topic"
                                                            value="{{ Auth::guard('student')->user()->idea->topic }}">
                                                        @error('topic')
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter Tag#"
                                                            name="tag"
                                                            value="{{ Auth::guard('student')->user()->idea->tag }}">
                                                        @error('tag')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label" for="customCheck1">I have
                                                            read and
                                                            agreed to the <a href="#!" type="button" data-toggle="modal"
                                                                data-target="#exampleModalCenter">Term of
                                                                Conditions</a></label>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p class="mb-0" style="word-wrap: break-word;">
                                                                            By
                                                                            submitting a post to the university
                                                                            platform, you
                                                                            agree to adhere to the following terms and
                                                                            conditions:</p>

                                                                        <p>1. <b>Originality: You certify that the
                                                                                content
                                                                                submitted is your original work and does
                                                                                not
                                                                                infringe upon the intellectual property
                                                                                rights
                                                                                of any third party.</p></b>

                                                                        <p>2. <b>Accuracy: You warrant that all
                                                                                information
                                                                                provided in the post is accurate and
                                                                                truthful to
                                                                                the best of your knowledge.</p></b>

                                                                        <p>3. <b>Respect: You agree to maintain a
                                                                                respectful
                                                                                tone in your post, refraining from any
                                                                                language
                                                                                or content that is defamatory,
                                                                                discriminatory,
                                                                                or offensive.</p></b>

                                                                        <p>4. <b>Appropriateness: You acknowledge that
                                                                                the
                                                                                university platform is intended for
                                                                                academic
                                                                                discourse and will refrain from posting
                                                                                content
                                                                                that is inappropriate, including but not
                                                                                limited
                                                                                to, content of a sexual, violent, or
                                                                                explicit
                                                                                nature.</p></b>
                                                                        ...
                                                                        <p>5. <b>Copyright: You grant the university a
                                                                                ...
                                                                                modify,
                                                                                adapt, publish, translate, distribute,
                                                                                and
                                                                                display the content submitted in any
                                                                                medium or
                                                                                format.</p></b>

                                                                        <p>6. <b>Privacy: You will not disclose any
                                                                                personal or
                                                                                sensitive information of yourself or
                                                                                others in
                                                                                your post without their explicit
                                                                                consent.</p>
                                                                        </b>

                                                                        <p>7. <b>Compliance: You agree to comply with
                                                                                all
                                                                                university policies, including but not
                                                                                limited
                                                                                to, policies on academic integrity,
                                                                                conduct, and
                                                                                acceptable use of technology.</p></b>

                                                                        <p>8. <b>Responsibility: You acknowledge that
                                                                                you are
                                                                                solely responsible for the content you
                                                                                submit
                                                                                and any consequences that may arise from
                                                                                its
                                                                                publication.</p></b>

                                                                        <p>9. <b>Indemnity: You agree to indemnify and
                                                                                hold the
                                                                                university harmless from any claims,
                                                                                damages,
                                                                                losses, or liabilities arising out of or
                                                                                related
                                                                                to your submission, including but not
                                                                                limited
                                                                        ...
                                                                        <p>10. <b>Moderation: The university reserves
                                                                                the right
                                                                                to moderate, edit, or remove any content
                                                                                submitted to the platform that violates
                                                                                these
                                                                                terms and conditions or is otherwise
                                                                                deemed
                                                                                inappropriate.<br></b>

                                                                        <p>11. <b>Termination: The university reserves
                                                                                the right
                                                                                to suspend or terminate your access to
                                                                                the
                                                                                platform in the event of repeated
                                                                                violations of
                                                                                these terms and conditions.</p></b>

                                                                        <p>By submitting a post to the university
                                                                            platform, you
