    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h5>Edit {{ $single_admin->name }}'s account</h5>
                        <hr>
                        <form action="{{ route('admin_edit_profile_submit', $single_admin->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Enter Name"
                                            value="{{ $single_admin->name }}" disabled>
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="role" class="form-control" placeholder="Enter Email" name="email"
                                            value="{{ $single_admin->email }}" disabled>
                                        @error('email')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Role</label>
                                        <input type="role" class="form-control" value="Admin" readonly style="cursor: not-allowed! important;">
                                    </div>
                                    <label>Photo</label>
                                    ...
                                    <div class="input-group mb-3">
                                        <img src="{{ asset('/storage/uploads/' . $single_admin->photo) }}"
                                ...
                                <button class="btn btn-secondary" style="margin-left: 10px; background-color: greenyellow">
                                    <a href="{{ route('admin_profile') }}" style="color: green">Back to Profile</a>
                                </button>
                            </div>
                        </form>
                    </div>
