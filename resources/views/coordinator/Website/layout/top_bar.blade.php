<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
    <div class="m-header">
        ...
        <a href="{{ route('coordinator_home') }}" class="b-brand">
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img alt="No image" src="{{ asset('/storage/uploads/'.Auth::guard('coordinator')->user()->photo) }}" class="img-radius">
                            <span>{{ Auth::guard('coordinator')->user()->name }}</span>
                            <a href="{{ route('coordinator_logout') }}" class="dud-logout" title="Logout">
                                <i class="feather icon-log-out"></i>
                            </a>
                        </div>
                        <ul class="pro-body">
                            <li><a href="{{ route('coordinator_profile') }}" class="dropdown-item"><i
